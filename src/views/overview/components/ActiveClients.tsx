...
export function ActiveClients({ clients, loading, error = null, onRetry, onSelectClient }: ActiveClientsProps) {
  ...
  return (
    <CardShell loading={loading} error={error} onRetry={onRetry} skeleton={ActiveClientsSkeleton}>
      <div className="overview-card rounded-xl p-6 flex flex-col gap-4">
