      ...
      <div className="space-y-6">
        ...
        <div className="p-6 border border-yellow-200 dark:border-yellow-800 rounded-lg bg-yellow-50 dark:bg-yellow-900/20">
          ...
          <p className="text-sm text-yellow-700 dark:text-yellow-300">
            Para acessar o painel admin, configure a variável de ambiente <code className="px-1 py-0.5 bg-yellow-100 dark:bg-yellow-800 rounded text-xs">VITE_SUPABASE_SERVICE_ROLE_KEY</code> no arquivo <code className="px-1 py-0.5 bg-yellow-100 dark:bg-yellow-800 rounded text-xs">.env.local</code>.
          </p>
